...
export type RetrieveShakespeareanPokemon = (name: PokemonName) => TE.TaskEither<DomainError, ShakespeareanPokemon>;

export const retrieveShakespeareanPokemon = (
  repository: PokemonRepository,
  translator: ShakespeareanTranslator,
): RetrieveShakespeareanPokemon => (name: PokemonName) => pipe(repository(name), TE.chain(translator));
